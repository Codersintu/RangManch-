        ...
        <div className="flex flex-col gap-10 mt-4 items-center">
          ...
          <Link to="/">
            <div className="p-2 cursor-pointer hover:bg-gray-200  rounded-full">
              <img className="w-7" src={home} alt="icon" />
            </div>
          </Link>
          <Link to="/">
          <div className="p-2 cursor-pointer hover:bg-gray-200  rounded-full">
            <img className="w-7" src={compass} alt="icon" />
          </div>
          </Link>
          <Link to="/create">
          <div className="p-2 cursor-pointer hover:bg-gray-200  rounded-full">
            <img className="w-7" src={plus} alt="icon" />
          </div>
          </Link>
          <Link to="/">
          <div className="p-2 cursor-pointer hover:bg-gray-200  rounded-full">
            <img className="w-7" src={message} alt="icon" />
          </div>
          </Link>
          <div className="p-2 cursor-pointer hover:bg-gray-200  rounded-full">
            <img className="w-7" src={bell} alt="icon" />
          </div>
        </div>
